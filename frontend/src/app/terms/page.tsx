...
export const metadata: Metadata = {
  title: 'Terms of Service | Releeve',
  description: 'Terms governing access to and use of the Releeve platform.',
...
const sections: LegalSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      'Releeve is a developer platform for the Stellar network. It provides smart-contract simulation, state-fork environments, monitoring and alerting, programmatic access, and in-context chain investigation tools.',
  ...
  {
    heading: '10. Disclaimers of Warranty',
    paragraphs: [
  ...
  {
    heading: '14. Changes to the Service',
    paragraphs: [
