  ...
  return (
    <>
      ...
      <section className="pricing-plans marketing-frame">
        {plans.map((plan) => (
          <article key={plan.name} data-current={plan.current}>
            ...
            {plan.current ? <Link className="marketing-button marketing-button-primary" href="/contact">Talk to us <ArrowRight size={14} /></Link> : <span className="pricing-planned-button">Planned tier</span>}
          </article>
        ))}
      </section>
      ...
      <section className="marketing-final-cta marketing-frame">
        ...
        <div className="marketing-final-actions"><Link className="marketing-button marketing-button-ink" href="/contact">Talk to us <ArrowRight size={15} /></Link></div>
      </section>
    </>
  );
}
