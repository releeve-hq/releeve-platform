...
function ExplorerDesignStyles() {
  ...
  `}</style><style>{`
    .rx-json-block{max-width:460px;max-height:240px;margin:8px 0 0;padding:10px;border:1px solid var(--border);border-radius:5px;background:#171413;color:var(--text-dim);font:10.5px/1.5 ui-monospace,monospace;white-space:pre-wrap;overflow:auto;overflow-wrap:anywhere}
